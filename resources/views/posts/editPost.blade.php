        ...
        @method('PUT')
            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="content" id="content" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" required></textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="picture_url" class="block mt-1 w-full" type="text" name="picture_url" :value="old('picture_url')" required />
                            </div>
